	...
	const projects = [
		{
			...
			description:
				'모든 싸피인들의 편리한 올인원패키지 서비스, 다양한 익명 커뮤니티와 한번에 확인할 수 있는 커리큘럼 및 스터디와 팀빌딩까지 다른 플랫폼을 사용하지 않고 편리하게 서비스를 이용할 수 있는 애플리케이션을 개발',
			techStack:
				'Spring Boot, Spring Data JPA, Kotlin, Android, AWS EC2, Jenkins, Nginx, Gradle, Java 17',
			details: [
		...
		},
		{
			...
			name: 'CuteCatDog, 6인',
			description:
				'동물의 행동과 표정을 통해 감정을 분석하고 사용자가 동물에 대한 지식을 얻을 수 있는 펫케어 애플리케이션 개발',
		...
		},
		{
			...
			description:
				'얼굴 인식을 통하여 동물상으로 분류하여 비슷한 동물을 찾고 이를 통하여 랜덤 채팅과 퀴즈를 통해 자연스럽게 동물 보호에 관심을 갖도록 고무시키는 공익 서비스 개발',
		...
		},
		{
			...
			description:
				'SAMSUNG SOFTWARE ACADEMY에서 사용하는 서류를 입력만으로 자동으로 만들어주는 애플리케이션',
		...
		},
		{
			...
			description:
				'Online to Offline 서비스로 직접 방문하지 않고 커피를 주문하고 주문 목록을 관리하는 Mobile Application 개발',
