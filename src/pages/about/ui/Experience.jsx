...
function Experience() {
	...
	project.addDoing('MSA 기반 서버 아키텍처 설계 및 운영 환경 구성');
	...
	project.addDoing('UUID와 SHA256를 활용한 API Access Key 발급');
	project.addDoing('Spring Filter 를 활용한 API 보안 호출');
	project.addDoing('C#을 활용한 Window Application 개발');
	job.addProject(project);

	project = new Project();
	project.name = '업무 자동화 RPA 개발\n(Robotic Process Automation)';
	project.start = '2023-05';
	project.end = '2023-12';
	...
	project = new Project();
	project.name = 'AI를 활용한 리스크 관리 서비스 개발';
	project.start = '2025-01';
	project.end = '2025-09';
	project.skill = 'Java, Spring Boot, Python, Electron, Batch, ChatGPT OpenAI API, Perplexity Open API';
	project.description = 'AI를 활용한 항만 별 리스크 관리 서비스 개발';
	project.addDoing('전체 Process 설계 및 PoC 기술 리딩');
	project.addDoing('Java, Spring Boot를 활용한 AI RESTFul API 개발');
	project.addDoing('Electron, Python, 내부 RPA 솔루션을 활용한 크롤링');
	job.addProject(project);
